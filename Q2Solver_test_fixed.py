# -*- coding: utf-8 -*-
"""
Q2Solver_test_fixed.py - 修复版Q2求解器测试
修复多进程嵌套和Windows兼容性问题
"""
...
def quick_coverage_calculation(uav_id, heading, t_drop):
    ...
    coverage = 3.0 * angle_factor * distance_factor * time_factor * position_factors[uav_id]
    return max(0.0, coverage)

# ==================== 修复后的遗传算法 ====================
class FixedGeneticAlgorithm:
    """修复后的遗传算法，避免多进程嵌套"""
    ...
    def evolve(self):
        """进化过程"""
        print(f"🔬 开始修复版遗传算法优化 (使用 {os.cpu_count()} CPU核心)")
...
# ==================== 主测试函数 ====================
def test_fixed_q2_solver():
    """测试修复版的Q2求解器"""
    print("=" * 70)
    print("🛠️  Q2Solver 修复版测试")
    print("   修复内容：")
    print("   ✅ 移除多进程嵌套")
    print("   ✅ 使用线程池替代进程池")
    print("   ✅ 简化遮蔽计算避免复杂几何")
    ...
    try:
        # 运行修复版的遗传算法
        print("\n🚀 开始优化...")
        ga = FixedGeneticAlgorithm(population_size=20, generations=30)
        ...
        print("\n⏱️  计算时间统计:")        print(".3f"        print(".3f"
        print("\n🎉 测试成功！修复后的Q2Solver运行正常。")
